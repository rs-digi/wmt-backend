    ...
    (Wolmart.$window = t(window)),
      ...
      (Wolmart.initCartAction = function(e) {
        Wolmart.$body
          ...
          .on('click', '.cart-offcanvas .cart-header, .cart-close', function(
            e
          ) {
            t('.cart-dropdown').removeClass('opened'), e.preventDefault();
          });
      ...
      (Wolmart.headerToggleSearch = function(e) {
        ...
        a
          ...
          Wolmart.$body.on('click', '.sticky-footer .search-toggle', function(
            e
          ) {
            t(this)
              .parent()
              ...
              (function(e) {
                (e.$thumbs = e.$wrapper.find('.product-thumbs')),
                  ...
                  e.$thumbsDots.on('click', function(a) {
                    var i = t(this),
                      o = (i.parent().filter(e.$thumbs).length
                        ? i
                        : i.parent()
                      ).index(),
                      n = e.$wrapper
